...
Этот проект реализует MongoDB с шардированием и репликацией. Приложение `pymongo-api` взаимодействует с MongoDB через
два шарда.
...
[Схема (drow.io)](./mongo-sharding-repl.drawio)
[Схема (картинка)](./mongo-sharding-repl.png)
